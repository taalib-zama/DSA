...
public class HashMapSampleIteration {
    public static void main(String[] args) {
        ...
        System.out.println("============Iterating hashmap using stream and filter============");
            customMap.entrySet().stream()
                    .filter(e -> e.getValue().equals("Banana"))
        ...
        System.out.println("============Iterating hashmap using stream============");
